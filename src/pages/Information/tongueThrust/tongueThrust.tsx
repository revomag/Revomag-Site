            ...
            <section className={'tongue-thrust-content-container'}>
                ...
                <div className={'tongue-thrust-content-wrapper'}>
                    ...
                    <div>
                        ...
                        {/*<div className={"tongue-thrust-image-container"}>*/}
                        {/*    <img id={'tongue-thrust-image'} src={TongueThrustFour} alt={"Orthodontic damage due to tongue thrust example 4"} loading={'lazy'}/>*/}
                        {/*</div>*/}
                        {/*<div className={"tongue-thrust-image-container"}>*/}
                        {/*    <img id={'tongue-thrust-image'} src={TongueThrustSix} alt={"Orthodontic damage due to tongue thrust example 6"} loading={'lazy'}/>*/}
                        {/*</div>*/}
                    </div>
                </div>
