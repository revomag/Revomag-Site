...
export default function MouthBreathing(): ReactElement {
    return (
        <>
            ...
            <p><span style={{fontWeight: "bold"}}>-Oxygen absorption</span>. Nasal breathing regulates the amount of air that comes into the body. When you breathe through your mouth, you’re exhaling out too much carbon dioxide. We need CO2 to accumulate in our body in order to optimally utilize the oxygen we breathe in. Carbon dioxide plays a significant role in the release of oxygen from hemoglobin, it triggers breathing, maintains blood pH and prevents smooth muscle spasms.</p>
            <p style={{fontStyle: "italic"}}>Contrary to popular belief, oxygen is absorbed on the exhale, not the inhale. The back pressure created in the lungs with the slower exhale of nose breathing allows more time for the lungs to transfer oxygen to the blood. This exchange requires CO2. Exhaling through the mouth blows the CO2 out too quickly, resulting in less oxygen being absorbed.</p>
            ...
            <iframe width="700" height="394" src="https://www.youtube.com/embed/AcCHaNgwtwo?si=zlQUuXXhnWn_2rcI"
