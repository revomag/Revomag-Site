            ...
            <div className={"about-content-container"}>
                ...
                <div className={"about-content"}>
                    <div>
                        ...
                        <p>After learning about Myofunctional Therapy, Nicole realized that over the years she’s seen thousands of patients with myofunctional disorders and knew she wanted to help them. This was the missing puzzle piece. Nicole made the decision to continue her education and become an Orofacial Myofunctional Therapist. She is currently seeing children, age 5 and older, teens and adults. The focus of her practice, Santa Barbara Myo, is airway health and helping individuals return to their physiologic normal so they can breathe optimally and live their lives to their fullest potential.</p>
                        ...
                        <p>She enjoys spending time with her husband, two sons and goldendoodle, hiking, and baking in her free time.</p>
                    </div>
                </div>
            </div>
            <div className={"about-image-container"}>
