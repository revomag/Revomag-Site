    ...
    return (
        <>
            ...
            <div className={'how-content'}>
                ...
                <p>Costs: During your comprehensive exam you will receive a quote for your therapy based on an estimate of how many sessions will be required. Most patients require a comprehensive therapy program, which is $2,700. A pay in full discount is available or we can arrange a monthly payment plan. Dental and medical insurance usually do NOT help with the costs associated with myofunctional therapy, however we do accept funds from FSA and HSA accounts.</p><br/>
